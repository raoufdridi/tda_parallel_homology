...
#     res = []
#     for idx in range(0, len(K.edges)):
#         l =[0 for i in range(0, len(K.vertices))]
#         for v1 in K.edges[idx]:
...
#             K2 = partition[j]
#             if len(my_intersection(K1.vertices, K2.vertices)) !=0: #len(set(K1.vertices).intersection(set(K2.vertices)))!=0:
#                 res += [(K1, K2)]
#     return res
...
#         for j in range(i+1, len(partition)):
#             K2 = partition[j]
#             if len(my_intersection(K1.edges, K2.edges)) !=0:  #   len(set(K1.edges).intersection(set(K2.edges)))!=0:
#                 res += [(K1, K2)]
#     return res
...
#             K2 = partition[j]
#             if len(my_intersection(K1.edges, K2.edges)) !=0: #len(set(K1.edges).intersection(set(K2.edges)))!=0:
#                 #print len(set(K1.edges).intersection(set(K2.edges)))
#                 res += [(K1, K2)]
#     return res
